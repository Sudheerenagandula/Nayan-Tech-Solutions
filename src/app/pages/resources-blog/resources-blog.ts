...
export class ResourcesBlog {
  posts: BlogPost[] = [
    ...
    {
      excerpt: 'Building Strong Teams Through IT and Non-IT Staffing Expertise from Manvision.',
    ...
    {
      excerpt: 'The IT Skills That Guarantee a Job in 2026: ManVision\u2019s Must-Learn List',
      image: 'blog/blog-hr-outsourcing.jpg',
      path: '/resources/blog/payroll-compliance'
    },
    {
      excerpt: 'Study \u2192 Train \u2192 Get Placed: The ManVision Roadmap to IT Jobs in Australia',
