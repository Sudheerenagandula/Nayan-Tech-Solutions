...
export class Compliance {
  ...
  paragraphs: string[] = [
    'In the era of digital transformation, businesses must modernize their strategies, make IT investment a priority, and evolve with the technology so that companies can scale. At Nayan Tech, we have the right consulting in your modernization efforts and ensure technology aligns with business goals.',
