...
export class RemoteHiring {
  ...
  recentPosts: RecentPost[] = [
    {
      title:
        'Top Recruitment Companies in Australia: How to Choose the Best for Your Hiring Needs',
      image: 'blog/blog-top-recruitment-companies-australia.jpg',
      path: '/blog/top-recruitment-companies-australia',
      date: 'February 23, 2026',
    },
    {
      title: 'ManVision: Leading Recruitment Company in Australia for Skilled Talent',
    ...
    {
      title:
        'Building Strong Teams Through IT and Non-IT Staffing Expertise from Manvision',
